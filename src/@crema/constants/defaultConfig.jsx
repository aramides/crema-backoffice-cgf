...
export const defaultTheme = {
  theme: {
    ...
    palette: {
      mode: import.meta.env.VITE_APP_THEME_MODE,
      background: {
        paper: '#FFFFFF',
        default: '#F4F7FE',
      },
      primary: {
        main: import.meta.env.VITE_APP_PRIMARY_COLOR,
        contrastText: '#fff',
      },
      secondary: {
        main: import.meta.env.VITE_APP_SECONDARY_COLOR,
      },
      success: {
        main: '#11C15B',
        light: '#D9F5E5',
...
const defaultConfig = {
  ...
  themeMode: import.meta.env.VITE_APP_THEME_MODE,
  navStyle: import.meta.env.VITE_APP_NAV_STYLE,
  layoutType: import.meta.env.VITE_APP_LAYOUT_TYPE,
